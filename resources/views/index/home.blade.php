    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 first">
          <br/><br/><iframe width="560" height="366" src="https://www.youtube.com/embed/5bc_s-o-94k?rel=0" title="YouTube video player" style="border-radius: 5px;border:10px solid #007BFF;box-shadow: 10px 10px #1C4075;" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          
          <!--<video id="video" class="fanclub" src="https://fanclub.world/FanClubWorld.mp4"  autoplay loop preload="auto" plays-inline controls width="100%"></video>-->
