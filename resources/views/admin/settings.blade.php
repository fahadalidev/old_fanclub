        	...
        	<div class="box">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/settings') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">{{ trans('general.ffmpeg_path') }}</label>
                      <div class="col-sm-10">
                        <input type="text" value="{{ env('FFMPEG_PATH') }}" name="ffmpeg_path" class="form-control" placeholder="../ffmpeg">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
