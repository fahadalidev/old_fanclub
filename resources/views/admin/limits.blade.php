        	...
        	<div class="box">
                ...
                <div class="box-body">
                  <div class="form-group margin-zero">
                    ...
                    <div class="col-sm-10">
                      <select name="limit_categories" class="form-control">
                          <option @if( $settings->minimum_photo_width == 300 ) selected="selected" @endif value="300">300 px</option>
                          <option @if( $settings->minimum_photo_width == 400 ) selected="selected" @endif value="400">400 px</option>
                          <option @if( $settings->minimum_photo_width == 500 ) selected="selected" @endif value="500">500 px</option>
                          <option @if( $settings->minimum_photo_width == 600 ) selected="selected" @endif value="600">600 px</option>
                          <option @if( $settings->minimum_photo_width == 700 ) selected="selected" @endif value="700">700 px</option>
                          <option @if( $settings->minimum_photo_width == 800 ) selected="selected" @endif value="800">800 px</option>
                          <option @if( $settings->minimum_photo_width == 1000 ) selected="selected" @endif value="1000">1000 px</option>
                            <option @if( $settings->minimum_photo_width == 1200 ) selected="selected" @endif value="1200">1200 px</option>
                        </select>
                    </div>
                  </div>
                </div><!-- /.box-body -->
